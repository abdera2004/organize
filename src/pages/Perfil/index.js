...
export default function Perfil({ navigation }) {
    ...
    const { userName } = route.params || { userName: 'Usuário' }; // Fallback para 'Usuário' se não houver nome

    return (
        <View style={styles.containerHome}>
            <View style={styles.headerEditarPerfil}>
                <Pressable onPress={() => navigation.navigate('Home', { userName: userName })}>
                    <Image
            ...
            <View style={styles.menu}>
                ...
                <Text style={styles.nomeUsuario}>{userName}</Text> {/* Exibe o nome do usuário */}
